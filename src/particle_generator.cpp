...
// сохраним индекс последней использованной частица для ускорения поиска
unsigned int lastUsedParticle = 0;
unsigned int ParticleGenerator::firstUnusedParticle()
{    
    //пробуем начать с предыдущего индекса  по идее частичы должны отмерять по очереди
    ...
    // если не нашли начнем с начала (с первого индекса)
    ...
    // если ничего не нашли погибших частиц просто отправим первую частицу (но лучше настроит время жизни) 
    lastUsedParticle = 0;
    return 0;
}
